...
//   const alerts = useQuery(api.alerts.list, { includeArchived: showArchived });
//   const markAsRead = useMutation(api.alerts.markAsRead);
//   const markAllAsRead = useMutation(api.alerts.markAllAsRead);
//   const archiveAlert = useMutation(api.alerts.archive);
...
//   const handleAlertClick = async (alert: Doc<"alerts">) => {
//     if (!alert.isRead) {
//       await markAsRead({ id: alert._id });
//     }
//     if (alert.actionUrl) {
