...
//   const currentNetWorth = useQuery(api.netWorth.calculateCurrent);
//   const snapshots = useQuery(api.netWorth.list);
//   const trendData = useQuery(api.netWorth.getTrend, { period });
//   const createSnapshot = useMutation(api.netWorth.createSnapshot);
//   const deleteSnapshot = useMutation(api.netWorth.remove);
...
//   const handleDeleteSnapshot = async (id: Id<"netWorthSnapshots">) => {
//     try {
