        ...
        <Card className="glass-card">
          ...
          <CardContent className="prose prose-sm max-w-none dark:prose-invert">
            <section className="space-y-4">
              <h2 className="text-lg font-semibold mt-6">1. Agreement to Terms</h2>
              <p>
              ...
              <h3 className="text-base font-semibold mt-4">3.1 Account Creation</h3>
              <p>
              ...
              <h3 className="text-base font-semibold mt-4">3.2 Account Eligibility</h3>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">4. User Responsibilities</h2>
              <p>You agree to:</p>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h2 className="text-lg font-semibold mt-6">5. Financial Information Disclaimer</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">6. Data Accuracy</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">8. User Content</h2>
              <h3 className="text-base font-semibold mt-4">8.1 Your Data</h3>
              <p>
              ...
              <h3 className="text-base font-semibold mt-4">8.2 Data Export</h3>
              <p>
                You can export your data at any time through the Service's export functionality.
              </p>

              <h2 className="text-lg font-semibold mt-6">9. AI Features</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">10. Third-Party Services</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">11. Service Modifications</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">14. Warranty Disclaimer</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">15. Termination</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">16. Governing Law</h2>
              <p>
                These Terms shall be governed by and construed in accordance with the laws of
                [Your Jurisdiction], without regard to its conflict of law provisions.
              </p>

              <h2 className="text-lg font-semibold mt-6">17. Dispute Resolution</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">18. Severability</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">19. Entire Agreement</h2>
              <p>
              ...
              <h2 className="text-lg font-semibold mt-6">20. Contact Information</h2>
              <p>
