        ...
        <Card className="glass-card">
          ...
          <CardContent className="text-foreground">
            <section className="space-y-4">
              ...
              <h3 className="text-base font-semibold text-foreground mt-4">2.1 Personal Information</h3>
              <p className="text-foreground">We collect the following types of personal information:</p>
              ...
              <h3 className="text-base font-semibold text-foreground mt-4">2.2 Financial Information</h3>
              <p className="text-foreground">
              ...
              <h3 className="text-base font-semibold text-foreground mt-4">2.3 Usage Information</h3>
              <p className="text-foreground">We automatically collect certain information about your device and usage:</p>
              <ul className="list-disc pl-6 space-y-2 text-foreground">
              ...
              <h2 className="text-lg font-semibold text-foreground mt-6">4. Data Storage and Security</h2>
              <p className="text-foreground">
              ...
              <h2 className="text-lg font-semibold text-foreground mt-6">5. Data Sharing and Disclosure</h2>
              <p className="text-foreground">We do not sell your personal information. We may share your information:</p>
              <ul className="list-disc pl-6 space-y-2 text-foreground">
              ...
              <h2 className="text-lg font-semibold text-foreground mt-6">6. Your Rights and Choices</h2>
              ...
              <h2 className="text-lg font-semibold text-foreground mt-6">8. Third-Party Services</h2>
              <p className="text-foreground">
              ...
              <h2 className="text-lg font-semibold text-foreground mt-6">9. International Data Transfers</h2>
              <p className="text-foreground">
              ...
              <h2 className="text-lg font-semibold text-foreground mt-6">10. Children's Privacy</h2>
              <p className="text-foreground">
              ...
              <h2 className="text-lg font-semibold text-foreground mt-6">11. Changes to This Privacy Policy</h2>
              <p className="text-foreground">
              ...
              <h2 className="text-lg font-semibold text-foreground mt-6">12. Contact Us</h2>
              <p className="text-foreground">
